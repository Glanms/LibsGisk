...
import com.base.list.libsgisk.widget.view.ShadowLayout;
...
public class PictureDetailsActivity extends BaseActivity {
    ...
    TextView mTextView;
    @Bind(R.id.topLevelLayout)
    FrameLayout mTopLevelLayout;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap bitmap = BitmapInfo.getBitmap(getResources(),
    ...
    public void runEnterAnimation() {
        final long duration = (long) (ANIM_DURATION * RevealTransActivity.sAnimatorScale);
